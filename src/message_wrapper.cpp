...
template <typename T>
const geometry_msgs::TwistStamped MessageWrapper::createRosTwistStampedMessage(const T& ref_sbg_ekf_vel_msg, const sbg_driver::SbgEkfNav& ref_sbg_ekf_nav_msg, const sbg_driver::SbgImuData& ref_sbg_imu_msg) const
{
...
template const geometry_msgs::TwistStamped MessageWrapper::createRosTwistStampedMessage<sbg_driver::SbgEkfQuat>(const sbg_driver::SbgEkfQuat&, const sbg_driver::SbgEkfNav&, const sbg_driver::SbgImuData&) const;
template const geometry_msgs::TwistStamped MessageWrapper::createRosTwistStampedMessage<sbg_driver::SbgEkfEuler>(const sbg_driver::SbgEkfEuler&, const sbg_driver::SbgEkfNav&, const sbg_driver::SbgImuData&) const;
